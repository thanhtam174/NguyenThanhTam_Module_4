...
public class LibraryAop {
    ...
    @Pointcut("execution(* com.example.controller.PersonalCodeController.borrowBook(..))")
    ...
    @Pointcut("execution(* com.example.controller.PersonalCodeController.returnBook(..))")
    ...
    @Pointcut("execution(* com.example.controller.PersonalCodeController.*(..))")
